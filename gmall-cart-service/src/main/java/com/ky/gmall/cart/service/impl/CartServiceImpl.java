package com.ky.gmall.cart.service.impl;

import com.alibaba.dubbo.config.annotation.Service;
import com.alibaba.fastjson.JSON;
import com.ky.gmall.beans.OmsCartItem;
import com.ky.gmall.cart.mapper.OmsCartItemMapper;
...
public class CartServiceImpl implements CartService {
    ...
    public List<OmsCartItem> cartList(String userId) {
        Jedis jedis = null;
        String cartListStr = "user:"+userId+":cart";
        List<OmsCartItem> omsCartItems = new ArrayList<>();
        try {
            jedis = redisUtil.getJedis();
            List<String> hvals = jedis.hvals(cartListStr);
